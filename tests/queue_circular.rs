...
fn allocate_from_iter() {
  ...
  let queue = algorithms::queues::CircularQueue::from_iter(inputs.into_iter());
...
fn resize() {
  let inputs = [-1, 0, 65, 4, 32, 3, 90, -87];
  let mut queue = algorithms::queues::CircularQueue::from_iter(inputs.into_iter());
...
fn remove_from_mid_left() {
  ...
  let mut queue = algorithms::queues::CircularQueue::<i32>::from_iter(inputs.into_iter());
...
fn get() {
  let inputs = [-1, 0, 65, 4, 32, 3, 90, -87, 26, 43, 23, 32, 6, 7];
  let queue = algorithms::queues::CircularQueue::<i32>::from_iter(inputs.into_iter());
...
fn two_cyclic_push() {
  let inputs = [-1, 0, 65, 4, 32, 3, 90, -87, 26, 43, 23, 32, 6, 7];
  let mut queue = algorithms::queues::CircularQueue::<i32>::new(inputs.len() / 2);
