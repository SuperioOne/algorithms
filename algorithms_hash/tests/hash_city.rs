use algorithms_hash::cityhash::CityHash128;
use algorithms_hash::{cityhash::CityHash32, cityhash::CityHash64, HashFunc};
...
fn cityhash_64_beyond_65() {
  ...
  assert_eq!(
    0xD800360A5EE32429,
    hasher.get_hash(
      b"0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ01234\
    ...
    KLMNOPQRSTUVWXYZ0123456789ABCDEFGHIJKLMNO\
    PQRSTUVWXYZ0123456789ABCDEFGHIJKLMNOPQRST\
    UVWXYZ0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ"
    )
  );
}
...
fn cityhash_128_less_than_128() {
  ...
  assert_eq!(
    ...
    hasher.get_hash(
      b"0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ01234\
      56789ABCDEFGHIJKLMNOPQR"
    )
  );
  assert_eq!(
    0x3058F429847758080D13719241C3BA84,
    hasher.get_hash(
      b"0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ01234\
    56789ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789\
...
fn cityhash_128_greater_than_127() {
  ...
  assert_eq!(
    0x2D0B83D3524FC5C2C349A6AB84C2BF28,
    hasher.get_hash(
      b"0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ01234\
    56789ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789\
  ...
  assert_eq!(
    0x88F058253CBF2DB8619EC93C451ECE96,
    hasher.get_hash(
      b"0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ01234\
    56789ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789\
    ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789ABCDE\
...
fn cityhash_crc256_verify() {
  use algorithms_hash::cityhash::CityHashCrc256;
  ...
  assert_eq!(
    ...
    hasher.get_hash(HTMX_COPY_PASTA).into()
  );
}

#[test]
fn cityhash_crc128_verify() {
  use algorithms_hash::cityhash::CityHashCrc128;
  ...
  assert_eq!(
    ...
    hasher.get_hash(HTMX_COPY_PASTA)
  );
}
